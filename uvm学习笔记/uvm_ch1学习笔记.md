...
### 1.3.4 SystemVerilog 与 C/C++ 的连接（🟢 低）
...
## 1.4 为什么有了 SystemVerilog 还需要方法学（🟢 低）
### 1.4.1 语言只提供积木（🟢 低）
